...
| [docs/Decisions/ADR-009](docs/Decisions/ADR-009-clinical-data-to-ai-provider.md) | Что из клиники ребёнка покидает периметр ради ИИ |
| [docs/Decisions/ADR-010](docs/Decisions/ADR-010-production-checklist.md) | Чек-лист prod-контура (этап 8b) |
| [docs/Decisions/ADR-011](docs/Decisions/ADR-011-center-readonly.md) | Только чтение при истёкшей подписке — триггер, не гейт в функциях |
