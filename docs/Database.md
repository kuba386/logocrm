...
колонок (0022), не голый `on delete set null`, как у 0036/0066 (без списка
Postgres зануляет ВСЮ составную пару, включая `center_id not null`, и
любое физическое удаление `teachers` падает загадочным not-null violation
вместо тихого каскада) — долг 0036/0066, не чинится этой миграцией.
