...
| 7 | Клиника: диагностика, цели, ДЗ, AI-резюме | ⬜ код влит, приёмка идёт |
...
## Этап 7 — Клиника: диагностика, цели, ДЗ, AI-резюме ⬜ (код влит, живая приёмка п. 3 и 6 идёт)

**Статус.** Разрезано на три части 19.09.2026 (согласовано владельцем, см. `reports/stage-7.md`). 7a — клиническое ядро без ИИ (0036–0040, PR #77–#86). 7b — голос и ИИ на уровне базы (0041–0042), провайдер один — OpenAI. 7c — месячный отчёт (0043), уведомления по ДЗ (0045), видео к ДЗ решено вести через WhatsApp специалиста, Storage не нужен. Сверх плана: тренд по цели (0046), доставка резюме родителю и отказа диктовки специалисту (0047), панель заметок с «Утвердить» и экран отчёта за месяц (PR #103, #105). Живая приёмка 22.09.2026: голосовое → черновик за 39 с проходит; доставка родителю и отчёт ждут подтверждения владельцем (`reports/stage-7.md`, раздел «Живая приёмка 22.09.2026»). Открыто: список целей ребёнка в промпт модели — до него оценки по целям из голосового отключены заплаткой в n8n.
