-- =============================================================================
-- 0015_freeze_state_unification.sql — заморозка: один источник правды
--
...
-- снимком (0015, раздел 11, подбор кандидата) — сменить услугу у типа
...
as $$
  ...
  -- родитель не спросит.
  --
  -- frozen ПЕРЕД expired (найдено ревью написанного кода, до 0015 не
