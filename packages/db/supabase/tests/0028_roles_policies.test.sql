...
select set_eq(
  ...
  'Таблицы с tenant_admin без решения по новым ролям: attendance_statuses (read_all), invitations, message_templates (0034 — настройка центра), девять клинических таблиц (0036) и две junction диагностики (0059) — ни стойке, ни бухгалтеру не положены, FEATURE_MATRIX сноска ⁵; новая таблица роняет'
);
select is(
