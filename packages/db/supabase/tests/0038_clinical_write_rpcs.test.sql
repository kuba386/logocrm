...
-- parent_summary заполнен: с 0047 утвердить заметку без резюме для
-- родителя нельзя, а ниже эта заметка утверждается.
insert into public.lesson_notes (id, center_id, lesson_id, student_id, status, created_by, parent_summary) values
  ('2f000000-0000-0000-0000-000000000001','2ccccccc-0000-0000-0000-00000000000a','2fffffff-0000-0000-0000-000000000001','2eeeeeee-0000-0000-0000-000000000001','draft','24444444-4444-4444-4444-444444444444','Резюме для родителя');
