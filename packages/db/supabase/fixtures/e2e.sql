...
-- минут без разрыва, все в прошлом на момент прогона: конец последнего —
-- за 15 минут до now(), начало первого — за 5 часов. Учитель тот же, что
...
values
  ('e0000000-0000-0000-0000-0000000a0001', 'e0000000-0000-0000-0000-0000000000c1',
   ...
   'e0000000-0000-0000-0000-0000000000e2', now() - interval '5 hours', now() - interval '5 hours' + interval '45 min'),
  ('e0000000-0000-0000-0000-0000000a0002', 'e0000000-0000-0000-0000-0000000000c1',
   'e0000000-0000-0000-0000-0000000000f1', 'e0000000-0000-0000-0000-0000000000b1',
   'e0000000-0000-0000-0000-0000000000e2', now() - interval '4 hours', now() - interval '4 hours' + interval '45 min'),
  ('e0000000-0000-0000-0000-0000000a0003', 'e0000000-0000-0000-0000-0000000000c1',
   'e0000000-0000-0000-0000-0000000000f1', 'e0000000-0000-0000-0000-0000000000b1',
   'e0000000-0000-0000-0000-0000000000e2', now() - interval '3 hours', now() - interval '3 hours' + interval '45 min'),
  ('e0000000-0000-0000-0000-0000000a0004', 'e0000000-0000-0000-0000-0000000000c1',
   'e0000000-0000-0000-0000-0000000000f1', 'e0000000-0000-0000-0000-0000000000b1',
   'e0000000-0000-0000-0000-0000000000e2', now() - interval '2 hours', now() - interval '2 hours' + interval '45 min'),
  ('e0000000-0000-0000-0000-0000000a0005', 'e0000000-0000-0000-0000-0000000000c1',
   'e0000000-0000-0000-0000-0000000000f1', 'e0000000-0000-0000-0000-0000000000b1',
   'e0000000-0000-0000-0000-0000000000e2', now() - interval '1 hours', now() - interval '1 hours' + interval '45 min')
on conflict (id) do nothing;
